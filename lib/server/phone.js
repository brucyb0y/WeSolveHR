// Phone-number normalisation, extracted verbatim from the original monolith.
// Login accepts whatever the user types (with or without whatsapp: prefix,
// country code or separators), so every lookup goes through here.
