// Help command guide data. Ported verbatim from the `sections` array in
// renderHelpPage() (lib/server/app.js). A command is either a plain string or
// { cmd, desc }. Sections marked admin:true only show to managers/admins.
